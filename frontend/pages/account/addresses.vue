        ...
        <div v-else class="space-y-3">
            ...
            >
                <div class="text-sm">
                    ...
                    <span
                        v-if="a.is_default"
                        class="text-xs bg-green-100 text-green-700 px-2 py-0.5 rounded-full mt-1 inline-block"
                        >Mặc định</span
                    >
                </div>
...
import type { Address, ApiSuccess } from "~/types/models.types";
...
const { data: addressesResponse, refresh } = await useAsyncData<
    ApiSuccess<Address[]>
>("addresses", () => useApi()("crm/v1/addresses"));
