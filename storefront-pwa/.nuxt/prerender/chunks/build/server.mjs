import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { hasInjectionContext, getCurrentInstance, inject, defineComponent, createElementBlock, shallowRef, provide, cloneVNode, h, defineAsyncComponent, computed, unref, shallowReactive, ref, Suspense, Fragment, useSSRContext, createApp, mergeProps, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, reactive, effectScope, getCurrentScope, toRef, withCtx, nextTick, isReadonly, isRef, toRaw, isShallow, isReactive, Text } from 'file://C:/laragon/www/ecom-wms/storefront-pwa/node_modules/vue/index.mjs';
import { $fetch } from 'file://C:/laragon/www/ecom-wms/storefront-pwa/node_modules/ofetch/dist/node.mjs';
import { e as baseURL } from '../_/nitro.mjs';
import { createHooks } from 'file://C:/laragon/www/ecom-wms/storefront-pwa/node_modules/hookable/dist/index.mjs';
import { getContext, executeAsync } from 'file://C:/laragon/www/ecom-wms/storefront-pwa/node_modules/unctx/dist/index.mjs';
import { createError as createError$1, sanitizeStatusCode, getRequestProtocol, getRequestHeaders, getRequestHeader, setCookie, getCookie, deleteCookie } from 'file://C:/laragon/www/ecom-wms/storefront-pwa/node_modules/h3/dist/index.mjs';
import { setActivePinia, createPinia, shouldHydrate } from 'file://C:/laragon/www/ecom-wms/storefront-pwa/node_modules/pinia/dist/pinia.prod.cjs';
import { defu } from 'file://C:/laragon/www/ecom-wms/storefront-pwa/node_modules/defu/dist/defu.mjs';
import { useRoute as useRoute$1, RouterView, createMemoryHistory, createRouter, START_LOCATION, isNavigationFailure } from 'file://C:/laragon/www/ecom-wms/storefront-pwa/node_modules/vue-router/vue-router.node.mjs';
import { klona } from 'file://C:/laragon/www/ecom-wms/storefront-pwa/node_modules/klona/dist/index.mjs';
import { parse as parse$1 } from 'file://C:/laragon/www/ecom-wms/storefront-pwa/node_modules/nuxt/node_modules/cookie-es/dist/index.mjs';
import destr from 'file://C:/laragon/www/ecom-wms/storefront-pwa/node_modules/destr/dist/index.mjs';
import { isEqual as isEqual$1 } from 'file://C:/laragon/www/ecom-wms/storefront-pwa/node_modules/ohash/dist/index.mjs';
import { setupDevtoolsPlugin } from 'file://C:/laragon/www/ecom-wms/storefront-pwa/node_modules/vue-devtools-stub/dist/index.mjs';
import { ssrRenderAttrs, ssrInterpolate, ssrRenderSuspense, ssrRenderComponent, ssrRenderVNode } from 'file://C:/laragon/www/ecom-wms/storefront-pwa/node_modules/vue/server-renderer/index.mjs';
...
const __nuxt_page_meta$5 = { layout: "checkout" };
const __nuxt_page_meta$4 = { layout: "account" };
const __nuxt_page_meta$3 = { layout: "checkout" };
const __nuxt_page_meta$2 = { layout: "checkout" };
const __nuxt_page_meta$1 = { layout: "account" };
const __nuxt_page_meta = { layout: "checkout" };
const _routes = [
  {
    name: "index___vi",
    path: "/",
    component: () => import('./index-DbZ_RX4I.mjs')
  },
  {
    name: "login___vi",
    path: "/login",
    meta: { "middleware": "guest" },
    component: () => import('./login-D_PYvHiS.mjs')
  },
  {
    name: "register___vi",
    path: "/register",
    meta: { "middleware": "guest" },
    component: () => import('./register-DV6M7Bpw.mjs')
  },
  {
    name: "checkout-auth___vi",
    path: "/checkout/auth",
    meta: __nuxt_page_meta$a || {},
    component: () => import('./auth-CCjTczbG.mjs')
  },
  {
    name: "products-id___vi",
    path: "/products/:id()",
    component: () => import('./_id_-DipDCs7J.mjs')
  },
  {
    name: "account-orders___vi",
    path: "/account/orders",
    meta: { ...__nuxt_page_meta$8 || {}, ...{ "middleware": "auth" } },
    component: () => import('./orders-JQx7P-wa.mjs'),
    children: [
      {
        name: "account-orders-id___vi",
        path: ":id()",
        meta: { ...__nuxt_page_meta$9 || {}, ...{ "middleware": "auth" } },
        component: () => import('./index-6dZTdm7p.mjs')
      },
      {
        name: "account-orders-id-tracking___vi",
        path: ":id()/tracking",
        meta: { "middleware": "auth" },
        component: () => import('./tracking-BlRfvIwK.mjs')
      }
    ]
  },
  {
    name: "account-loyalty___vi",
    path: "/account/loyalty",
    meta: { ...__nuxt_page_meta$7 || {}, ...{ "middleware": "auth" } },
    component: () => import('./loyalty-oJ7u6kvF.mjs')
  },
  {
    name: "account-profile___vi",
    path: "/account/profile",
    meta: { ...__nuxt_page_meta$6 || {}, ...{ "middleware": "auth" } },
    component: () => import('./profile-DgnUqXmQ.mjs')
  },
  {
    name: "category-slug___vi",
    path: "/category/:slug()",
    component: () => import('./_slug_-B9A2O8xr.mjs')
  },
  {
    name: "checkout-review___vi",
    path: "/checkout/review",
    meta: __nuxt_page_meta$5 || {},
    component: () => import('./review-4-8QMZl5.mjs')
  },
  {
    name: "account-wishlist___vi",
    path: "/account/wishlist",
    meta: { ...__nuxt_page_meta$4 || {}, ...{ "middleware": "auth" } },
    component: () => import('./wishlist-CNrtXs4l.mjs')
  },
  {
    name: "checkout-payment___vi",
    path: "/checkout/payment",
    meta: __nuxt_page_meta$3 || {},
    component: () => import('./payment-DPg04Ota.mjs')
  },
  {
    name: "checkout-success___vi",
    path: "/checkout/success",
    meta: __nuxt_page_meta$2 || {},
    component: () => import('./success-CCMYQ0jw.mjs')
  },
  {
    name: "account-addresses___vi",
    path: "/account/addresses",
    meta: { ...__nuxt_page_meta$1 || {}, ...{ "middleware": "auth" } },
    component: () => import('./addresses-lPfUU5Zn.mjs')
  },
  {
    name: "checkout-shipping___vi",
    path: "/checkout/shipping",
    meta: __nuxt_page_meta || {},
    component: () => import('./shipping-D4dAvuyz.mjs')
  }
];
...
const namedMiddleware = {
  auth: () => import('./auth-p0DWUmXq.mjs'),
  guest: () => import('./guest-C5ikP5Cj.mjs')
};
...
const layouts = {
  account: defineAsyncComponent(() => import('./account-Bh-PWT9J.mjs').then((m) => m.default || m)),
  checkout: defineAsyncComponent(() => import('./checkout-iGrpc6cR.mjs').then((m) => m.default || m)),
  default: defineAsyncComponent(() => import('./default-CSur3IPs.mjs').then((m) => m.default || m))
};
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "min-h-screen flex items-center justify-center bg-gray-50 px-4" }, _attrs))}><div class="text-center space-y-4"><p class="text-8xl font-black text-gray-200">${ssrInterpolate(__props.error?.statusCode ?? 500)}</p><h1 class="text-2xl font-bold text-gray-700">${ssrInterpolate(__props.error?.statusCode === 404 ? "Trang không tìm thấy" : "Có lỗi xảy ra")}</h1><p class="text-gray-400 text-sm max-w-sm mx-auto">${ssrInterpolate(__props.error?.message)}</p><div class="flex gap-3 justify-center pt-2"><button class="bg-indigo-600 text-white px-6 py-2.5 rounded-lg font-semibold hover:bg-indigo-700"> Về trang chủ </button><button class="border px-6 py-2.5 rounded-lg hover:bg-gray-50"> Thử lại </button></div></div></div>`);
    };
  }
});
...
export { _export_sfc as _, useRuntimeConfig as a, useNuxtApp as b, asyncDataDefaults as c, createError as d, entry_default as default, defineNuxtRouteMiddleware as e, useRouter as f, encodeRoutePath as g, hasProtocol as h, withoutTrailingSlash as i, joinURL as j, nuxtLinkDefaults as k, navigateTo as n, parseQuery as p, resolveRouteObject$1 as r, tryUseNuxtApp as t, useRoute as u, withTrailingSlash as w };
