import { createRenderer, getRequestDependencies, getPreloadLinks, getPrefetchLinks } from 'file://C:/laragon/www/ecom-wms/storefront-pwa/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { getResponseStatusText, getResponseStatus, getQuery, createError, appendResponseHeader } from 'file://C:/laragon/www/ecom-wms/storefront-pwa/node_modules/h3/dist/index.mjs';
...
import { renderToString } from 'file://C:/laragon/www/ecom-wms/storefront-pwa/node_modules/vue/server-renderer/index.mjs';
import { createHead as createHead$1, propsToString, renderSSRHead } from 'file://C:/laragon/www/ecom-wms/storefront-pwa/node_modules/unhead/dist/server.mjs';
import { stringify, uneval } from 'file://C:/laragon/www/ecom-wms/storefront-pwa/node_modules/devalue/index.js';
import { FlatMetaPlugin, DeprecationsPlugin, PromisesPlugin, TemplateParamsPlugin, AliasSortingPlugin } from 'file://C:/laragon/www/ecom-wms/storefront-pwa/node_modules/unhead/dist/plugins.mjs';
import { walkResolver } from 'file://C:/laragon/www/ecom-wms/storefront-pwa/node_modules/unhead/dist/utils.mjs';
import { isRef, toValue, hasInjectionContext, inject, ref, watchEffect, getCurrentInstance, onBeforeUnmount, onDeactivated, onActivated } from 'file://C:/laragon/www/ecom-wms/storefront-pwa/node_modules/vue/index.mjs';
...
const appHead = {"meta":[{"name":"viewport","content":"width=device-width, initial-scale=1"},{"charset":"utf-8"}],"link":[{"rel":"preconnect","href":"https://fonts.bunny.net"}],"style":[],"script":[],"noscript":[]};
